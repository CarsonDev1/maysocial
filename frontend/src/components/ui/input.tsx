	...
	return (
		<input
			...
			className={cn(
				...
				'[&:-webkit-autofill]:bg-transparent [&:-webkit-autofill]:transition-[background-color] [&:-webkit-autofill]:duration-[9999s] [&:-webkit-autofill]:[-webkit-text-fill-color:#000000] caret-black',
				'focus-visible:border-none focus-visible:ring-ring/50 focus-visible:ring-2',

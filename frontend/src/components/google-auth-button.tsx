...
export function GoogleAuthButton({ className, ...props }: GoogleAuthButtonProps) {
	return (
		<Button
			variant='outline'
			className={cn(
				'group w-full h-full transition-all duration-300 overflow-visible rounded-md group hover:bg-accent-foreground',
				className
			)}
			{...props}
		>
